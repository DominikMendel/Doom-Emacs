...
(defun vispero-roam() (directory-files-recursively "~/Dropbox/org/roam/vispero" "\\.org$"))

(defun personal-journals() (directory-files-recursively "~/Dropbox/org/roam/journal" "\\.org$"))

(defun all-roam() (directory-files-recursively "~/Dropbox/org/roam" "\\.org$"))
  #+end_src
...
(setq my-agenda-super-group-alltodo '((:name "Next to do"
                             :todo "NEXT"
                             :order 4)
                            (:name "Due Today"
                             :deadline today
...
(setq my-agenda-super-group-tags '((:name "Questions"
                           ;; '((
                           :tag "question"
                           ;; :anything t
                           ;; :auto-tags t
...
;; (add-hook 'org-journal-after-entry-create-hook 'org-create-new-id-journal)
...
(setq org-roam-capture-templates
        ...
        '(("d" "default" plain "- tags ::  %?\n* "
          ...
          ("a" "New Area" plain "- tags :: [[roam:Indexes]] %?\n* "
           :if-new (file+head "${slug}.org" "#+TITLE: ${title}\n")
           :unnarrowed t)
...
:END:"
          ...
          ("r" "Reading General")
          ("rr" "Reading" plain "- tags ::  %?\n* Notes\n* Overview"
           :if-new (file+head "${slug}.org" "#+TITLE: ${title}\n")
           :unnarrowed t)

          ("rc" "Reading Character" plain "- tags ::  %?\n* Notes\n* Mentions"
           :if-new (file+head "${slug}.org" "#+TITLE: ${title}\n")
           :unnarrowed t)
...
,#+TITLE: ${title}\n")
          ...
          ("v" "Vispero")
          ("vv" "Vispero Default" plain "- tags ::  %?\n* "
           :if-new (file+head "vispero/${slug}.org" "#+TITLE: ${title}\n")
           :unnarrowed t)

          ("vt" "Vispero Tagged" plain "- tags :: [[roam:Vispero]] %?\n* "
           :if-new (file+head "vispero/${slug}.org" "#+TITLE: ${title}\n")
           "%?"
           :unnarrowed t)

          ("vp" "Vispero People" plain "- tags :: [[roam:Vispero People]] %?\n* Time off\n| Start    | End      | Total days | Description |\n|-------+-----+------------+-------------|\n"
           :if-new (file+head "vispero/${slug}.org" "#+TITLE: ${title}\n")
           "%?"
           :unnarrowed t)
...
,#+TITLE: Bug ${title}\n#+filetags: :bug:\n")
  ...
  (setq org-roam-capture-ref-templates
        '(("e" "example" plain "- tags ::  %?\n* "
           :if-new (file+head "website/%(url-host (url-generic-parse-url \"${ref}\"))-${slug}.org" ":PROPERTIES:
:ROAM_REFS: ${ref}
:END:
,#+TITLE: ${title}\n")
           :unnarrowed t)
...
(defun my/org-focus-work()
  (interactive)
  (setq org-agenda-files (directory-files-recursively "~/Dropbox/org/roam/vispero" "\\.org$")
...
(after! org-roam
  (setq org-roam-dailies-capture-templates
        ;; I have no idea why, but leave "entryy" mispelled.
        ;; I am doing this to just open the buffer to edit. Might be vastly wrong.
        '(("d" "default" entryy ""
