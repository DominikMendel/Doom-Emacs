...
,#+begin_src elisp :tangle (when (eq (doom-system-distro) 'arch) "yes" "no")
(after! org
  (setq org-journal-dir "~/Dropbox/org/journal")
  )
,#+end_src

,#+begin_src elisp :tangle (when (eq (doom-system-distro) 'arch) "no" "yes")
(after! org-journal
...
;;           (lambda ()
;;             (save-excursion
;;               (let ((template "#+OPTIONS: num:nil"))
;;                 (beginning-of-buffer)
;;                 (unless (search-forward template nil t)
;;                   (insert template "\n\n"))))))
(setq org-journal-date-prefix "#+OPTIONS: num:nil\n* ")
#+end_src
* Custom functions
** Youtube url link
