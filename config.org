...
(after! org-roam
    ...
    (setq dm--org-roam-test-dir (expand-file-name "testing" org-roam-directory))
    (defun dm/get-test-filename (name)
        (expand-file-name
        (format "%.org" (s-snake-case)) dm--org-roam-test-dir))
...
,#+TITLE: ${title}\n")
          ...
          ("v" "Vispero")
          ("vv" "Vispero Default" plain (file ,dm--org-roam-vispero-default-template)
