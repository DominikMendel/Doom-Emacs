...
(after! org-roam
  ...
  (setq org-roam-directory "~/Dropbox/org/roam"
        ...
        '(("d" "default" plain "- tags ::  %?\n* "
          ...
          ;; This doesn't work. Org-id returns an error
...
,#+TITLE: ${title}\n")
          ...
          ("vb" "Vispero Bug" plain "- tags :: [[roam:Vispero Bugzilla]] %?\n"
           :if-new (file+head "vispero/bug${slug}.org" ":PROPERTIES:
...
#+RESULTS:
| r | ref | plain | #'org-roam-capture--get-point | %? | :file-name | website/%(url-host (url-generic-parse-url "${ref}"))-${slug} | :head | #+TITLE: ${title} |
...
(setq org-journal-dir "~/Dropbox/org/roam/vispero/journal"
      ...
      org-journal-file-format "Vispero Journal %Y/%W_%m-%d.org"
      +org-capture-todo-file "~/Dropbox/org/roam/vispero/vispero_agenda.org"
      )
