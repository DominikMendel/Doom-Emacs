...
(after! (:and org org-roam)
  ...
  (defvar dm--org-archive-location-personal (concat org-roam-directory dm--org-archive-type))
  (defvar dm--org-archive-location-vispero (concat dm--org-roam-vispero-dir "/" dm--org-archive-type))
  ...
  (defun my/set-org-variables ()
        (cond ((string-equal dm--my-focus "vispero")
