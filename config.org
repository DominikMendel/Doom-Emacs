...
(after! org-roam
    ...
    (defun my/set-org-roam-dailies-capture-templates ()
    ...
    (my/set-org-roam-dailies-capture-templates)
...
(setq +org-capture-todo-file "~/Dropbox/org/roam/personal_agenda.org")
